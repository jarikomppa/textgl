...
/* warning: x2 is multiplied by 2^16 */
...
#endif
#ifdef INTERP_STZ
  float D1, sz1,dszdx,dszdy,dszdl_min,dszdl_max;
  float D2, tz1,dtzdx,dtzdy,dtzdl_min,dtzdl_max;
#endif
...
#ifdef INTERP_STZ
  {
    ...
    D1 = (p1->sz- p0->sz);
    D2 = (p2->sz- p0->sz);
    dszdx = (((float)(fdy2)* D1)- ((float)(fdy1)* D2));
    dszdy = (((float)(fdx1)* D2)- ((float)(fdx2)* D1));
    
    D1 = (p1->tz- p0->tz);
    D2 = (p2->tz- p0->tz);
    dtzdx = (((float)(fdy2)* D1)- ((float)(fdy1)* D2));
    dtzdy = (((float)(fdx1)* D2)- ((float)(fdx2)* D1));
  }
#endif
