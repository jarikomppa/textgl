...
{
  glVertex4f(x,y,(float)(0),(float)(1));
}

void glVertex3f(GLfloat x,GLfloat y,GLfloat z) 
{
  glVertex4f(x,y,z,(float)(1));
}

void glVertex3fv(GLfloat *v) 
{
  glVertex4f(v[0],v[1],v[2],(float)(1));
}
...
void glColor4f(GLfloat r,GLfloat g,GLfloat b,GLfloat a)
{
  ...
  p[5].ui = (unsigned int) ((int)(((r* (float)(ZB_POINT_RED_MAX - ZB_POINT_RED_MIN))+(float)(ZB_POINT_RED_MIN))));
  p[6].ui = (unsigned int) ((int)(((g* (float)(ZB_POINT_GREEN_MAX - ZB_POINT_GREEN_MIN))+(float)(ZB_POINT_GREEN_MIN))));
  p[7].ui = (unsigned int) ((int)(((b* (float)(ZB_POINT_BLUE_MAX - ZB_POINT_BLUE_MIN))+ (float)(ZB_POINT_BLUE_MIN))));
  gl_add_op(p);
}
...
void glColor4fv(GLfloat *v)
{
  ...
  p[4].f=v[3];
  /* direct convertion to integer to go faster if no shading */
  p[5].ui = (unsigned int) ((int)(((v[0]* (float)(ZB_POINT_RED_MAX - ZB_POINT_RED_MIN))+ (float)(ZB_POINT_RED_MIN))));
  p[6].ui = (unsigned int) ((int)(((v[1]* (float)(ZB_POINT_GREEN_MAX - ZB_POINT_GREEN_MIN))+ (float)(ZB_POINT_GREEN_MIN))));
  p[7].ui = (unsigned int) ((int)(((v[2]* (float)(ZB_POINT_BLUE_MAX - ZB_POINT_BLUE_MIN))+ (float)(ZB_POINT_BLUE_MIN))));
  gl_add_op(p);
}

void glColor3f(GLfloat x,GLfloat y,GLfloat z) 
{
  glColor4f(x,y,z,(float)(1));
}

void glColor3fv(GLfloat *v) 
{
  glColor4f(v[0],v[1],v[2],(float)(1));
}
...
{
  glTexCoord4f(s,t,(float)(0),(float)(1));
}

void glTexCoord2fv(GLfloat *v)
{
  glTexCoord4f(v[0],v[1],(float)(0),(float)(1));
}
